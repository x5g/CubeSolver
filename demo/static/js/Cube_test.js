...
//boxs.dom.innerHTML='('+i+')'+''+boxs.x+' '+boxs.y+' '+boxs.z;
	...
	this.initStyle();
	//初始化各面颜色
	this.initColors=this.opts.colors||[['white'],['yellow'],['orange'],['red'],['green'],['blue']];
...
//	console.log(color5);
    ...
    //               48 49 50
    //               51 52 53
		var colorstop = this.colors[0], colorsbottom = this.colors[1], colorsleft = this.colors[2], colorsright = this.colors[3], colorsfront = this.colors[4], colorsback = this.colors[5];
    //top
		document.getElementById("f0").style.backgroundColor = colorstop[0];
		document.getElementById("f1").style.backgroundColor = colorstop[1];
		document.getElementById("f2").style.backgroundColor = colorstop[2];
		document.getElementById("f3").style.backgroundColor = colorstop[3];
		document.getElementById("f4").style.backgroundColor = colorstop[4];
		document.getElementById("f5").style.backgroundColor = colorstop[5];
		document.getElementById("f6").style.backgroundColor = colorstop[6];
		document.getElementById("f7").style.backgroundColor = colorstop[7];
		document.getElementById("f8").style.backgroundColor = colorstop[8];
    //bottom
		document.getElementById("f45").style.backgroundColor = colorsbottom[6];
		document.getElementById("f46").style.backgroundColor = colorsbottom[7];
		document.getElementById("f47").style.backgroundColor = colorsbottom[8];
		document.getElementById("f48").style.backgroundColor = colorsbottom[3];
		document.getElementById("f49").style.backgroundColor = colorsbottom[4];
		document.getElementById("f50").style.backgroundColor = colorsbottom[5];
		document.getElementById("f51").style.backgroundColor = colorsbottom[0];
		document.getElementById("f52").style.backgroundColor = colorsbottom[1];
		document.getElementById("f53").style.backgroundColor = colorsbottom[2];
    //left
		document.getElementById("f9").style.backgroundColor = colorsleft[0];
		document.getElementById("f10").style.backgroundColor = colorsleft[3];
		document.getElementById("f11").style.backgroundColor = colorsleft[6];
		document.getElementById("f21").style.backgroundColor = colorsleft[1];
		document.getElementById("f22").style.backgroundColor = colorsleft[4];
		document.getElementById("f23").style.backgroundColor = colorsleft[7];
		document.getElementById("f33").style.backgroundColor = colorsleft[2];
		document.getElementById("f34").style.backgroundColor = colorsleft[5];
		document.getElementById("f35").style.backgroundColor = colorsleft[8];
    //right
		document.getElementById("f15").style.backgroundColor = colorsright[6];
		document.getElementById("f16").style.backgroundColor = colorsright[3];
		document.getElementById("f17").style.backgroundColor = colorsright[0];
		document.getElementById("f27").style.backgroundColor = colorsright[7];
		document.getElementById("f28").style.backgroundColor = colorsright[4];
		document.getElementById("f29").style.backgroundColor = colorsright[1];
		document.getElementById("f39").style.backgroundColor = colorsright[8];
		document.getElementById("f40").style.backgroundColor = colorsright[5];
		document.getElementById("f41").style.backgroundColor = colorsright[2];
    //front
		document.getElementById("f12").style.backgroundColor = colorsfront[0];
		document.getElementById("f13").style.backgroundColor = colorsfront[1];
		document.getElementById("f14").style.backgroundColor = colorsfront[2];
		document.getElementById("f24").style.backgroundColor = colorsfront[3];
		document.getElementById("f25").style.backgroundColor = colorsfront[4];
		document.getElementById("f26").style.backgroundColor = colorsfront[5];
		document.getElementById("f36").style.backgroundColor = colorsfront[6];
		document.getElementById("f37").style.backgroundColor = colorsfront[7];
		document.getElementById("f38").style.backgroundColor = colorsfront[8];
    //back
		document.getElementById("f18").style.backgroundColor = colorsback[2];
		document.getElementById("f19").style.backgroundColor = colorsback[1];
		document.getElementById("f20").style.backgroundColor = colorsback[0];
		document.getElementById("f30").style.backgroundColor = colorsback[5];
		document.getElementById("f31").style.backgroundColor = colorsback[4];
		document.getElementById("f32").style.backgroundColor = colorsback[3];
		document.getElementById("f42").style.backgroundColor = colorsback[8];
		document.getElementById("f43").style.backgroundColor = colorsback[7];
		document.getElementById("f44").style.backgroundColor = colorsback[6];
};
//设置魔法拧动一次的时长 毫秒
...
Cube.prototype.turn3s=function(type,fnComplete){
    ...
    for (i = 0; i < type.length; i++) {
        if (type[i] == '2') type = type.replace('2', type[i - 1]);
    }
