...
def set_rgb_L(val):
    Twophase.vision_params.rgb_L = int(val)


def set_orange_L(val):
    Twophase.vision_params.orange_L = int(val)


def set_orange_H(val):
    Twophase.vision_params.orange_H = int(val)


def set_yellow_H(val):
    Twophase.vision_params.yellow_H = int(val)


def set_green_H(val):
    Twophase.vision_params.green_H = int(val)


def set_blue_H(val):
    Twophase.vision_params.blue_H = int(val)


def set_sat_W(val):
    Twophase.vision_params.sat_W = int(val)


def set_val_W(val):
    Twophase.vision_params.val_W = int(val)


def set_sigma_C(val):
    Twophase.vision_params.sigma_C = int(val)


def set_delta_C(val):
    Twophase.vision_params.delta_C = int(val)


def transfer():
    """Transfer the facelet colors detected by the opencv vision to the GUI editor."""
    if len(Twophase.vision_params.face_col) == 0:
        return
    centercol = Twophase.vision_params.face_col[1][1]

    Twophase.vision_params.cube_col[centercol] = Twophase.vision_params.face_col
    Twophase.vision_params.cube_hsv[centercol] = Twophase.vision_params.face_hsv
    ...
    for i in range(3):
        for j in range(3):
            canvas.itemconfig(facelet_id[dc[centercol]][i][j], fill=Twophase.vision_params.face_col[i][j])
...
s_orange_L.set(Twophase.vision_params.orange_L)
...
s_orange_H.set(Twophase.vision_params.orange_H)
...
s_yellow_H.set(Twophase.vision_params.yellow_H)
...
s_green_H.set(Twophase.vision_params.green_H)
...
s_blue_H.set(Twophase.vision_params.blue_H)
...
s_rgb_L.set(Twophase.vision_params.rgb_L)
...
s_sat_W.set(Twophase.vision_params.sat_W)
...
s_val_W.set(Twophase.vision_params.val_W)
...
s_sigma_C.set(Twophase.vision_params.sigma_C)
...
s_delta_C.set(Twophase.vision_params.delta_C)
