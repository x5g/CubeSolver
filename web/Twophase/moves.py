...
if not path.isfile(fname):
    ...
    for i in range(N_TWIST):
        a.set_twist(i)
        for j in Twophase.enums.Color:  # six faces U, R, F, D, L, B
    ...
    for i in range(N_UD_EDGES):
        ...
        for j in Twophase.enums.Color:
            for k in range(3):
                ...
                if j in [Twophase.enums.Color.R, Twophase.enums.Color.F, Twophase.enums.Color.L, Twophase.enums.Color.B] and k != 1:
                    continue
